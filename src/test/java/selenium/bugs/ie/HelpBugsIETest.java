...
//
//        driver = new RemoteWebDriver(new URL(Properties.NODE_IE), capability);
//    }
//
//    @After
...
//
//    @Test
//    public void test_자료실접근() throws InterruptedException {
...
////        new WebDriverWait(driver, WAIT_TIME).until(ExpectedConditions.urlToBe(BASE_URL+"board/notice"));
...
//        loginProcess();
//        
////        new WebDriverWait(driver, WAIT_TIME).until(ExpectedConditions.urlToBe(BASE_URL));
//        driver.findElement(By.linkText("고객센터")).click();
//        driver.findElement(By.linkText("나의 문의 확인")).click();
...
//
////        new WebDriverWait(driver, WAIT_TIME).until(ExpectedConditions.urlContains(LOGIN_OAUTH_URL));
